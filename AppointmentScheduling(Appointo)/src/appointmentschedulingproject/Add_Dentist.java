...
public class Add_Dentist extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ButtonAddDentist = new javax.swing.JButton();
        ...
        textSpeciality.setForeground(new java.awt.Color(160, 200, 215));
        textSpeciality.setBorder(null);
        textSpeciality.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                textSpecialityMouseClicked(evt);
            }
        });
        ...
        TextAddress.setForeground(new java.awt.Color(160, 200, 215));
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGap(60, 60, 60)
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(textid, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 228, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(fname)))))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(43, 43, 43)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(textSpeciality, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        ButtonAddDentist.setBackground(new java.awt.Color(150, 220, 220));
        ButtonAddDentist.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        ButtonAddDentist.setForeground(new java.awt.Color(255, 255, 255));
        ButtonAddDentist.setText("Add");
        ButtonAddDentist.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ButtonAddDentistActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(ButtonAddDentist, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(65, 65, 65))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(ButtonAddDentist)
                .addContainerGap())
        );

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, -1, 410));
    ...
    private void ButtonAddDentistActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonAddDentistActionPerformed
        if (!fname.getText().isEmpty() && !lname.getText().isEmpty() && !textid.getText().isEmpty()
            ...
            String spec = textSpeciality.getText();
            String address = TextAddress.getText();
            String password = textpassword.getText();
            Dentist dent = new Dentist(id, first, last, mail, phon, spec, address);
            Login log = new Login(id, password, "Dentist");
            if (db.addDentist(dent, log) == true) {
                JOptionPane.showMessageDialog(null, "dentist added successfuly");
                textid.setText("");
                fname.setText("");
                lname.setText("");
                phone.setText("");
                ...
                JOptionPane.showMessageDialog(null, "dentist adding failed");
            }
    ...
    }//GEN-LAST:event_ButtonAddDentistActionPerformed

    private void textSpecialityMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_textSpecialityMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_textSpecialityMouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new Add_Dentist().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton ButtonAddDentist;
