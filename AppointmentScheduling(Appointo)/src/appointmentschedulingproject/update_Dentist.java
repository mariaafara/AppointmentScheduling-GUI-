...
public class update_Dentist extends javax.swing.JFrame {

    //  updateRecep =new JButton("");
    public update_Dentist() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        updatedent = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jPanel1.setBackground(new java.awt.Color(150, 220, 220));

        labellogout.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        ...
        jPanel4.setLayout(new java.awt.GridLayout(6, 2, 20, 20));
        ...
        textaddress.setBackground(new java.awt.Color(200, 224, 220));
        ...
        spec.setBackground(new java.awt.Color(200, 224, 220));
        spec.setForeground(new java.awt.Color(255, 255, 255));
        spec.setBorder(null);
        ...
        searchRecep.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        ...
        jLabel10.setText("Enter  DentistID");
        ...
        updatedent.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        updatedent.setForeground(new java.awt.Color(255, 255, 255));
        updatedent.setText("update");
        updatedent.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                updatedentActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(updatedent, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(updatedent, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(31, 31, 31))))
        );
    ...
    private void searchRecepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchRecepActionPerformed
        ...
        spec.setText(r.getSpeciality());
        


    }//GEN-LAST:event_searchRecepActionPerformed

    private void updatedentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updatedentActionPerformed
        String id = textid.getText();
       ...
       if( db.updateDentist(id, first, last, mail, phone, add, s)==true)
           
          JOptionPane.showMessageDialog(null, "dentist edited successfuly");
      else 
          JOptionPane.showMessageDialog(null, "dentist editing failed");



    }//GEN-LAST:event_updatedentActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new update_Dentist().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton updatedent;
