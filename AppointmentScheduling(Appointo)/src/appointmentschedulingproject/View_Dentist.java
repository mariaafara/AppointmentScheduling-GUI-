...
public class View_Dentist extends javax.swing.JFrame {

    DataBaseManager db = new DataBaseManager();

    public View_Dentist() throws SQLException {
    ...
    private void initComponents() {
        ...
        jtable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "first name", "last name", "email", "phone", "scpeciality", "address"
            }
        ) {
    ...
    private void updateTable()  {
        ...
        try {
            db.rs = db.statement.executeQuery("select * from Dentist");
            DefaultTableModel def = new DefaultTableModel();
             def=new DefaultTableModel(new Object[][]{},
                         new String[]{"Id","first name","last name","email","phone", "speciality","adress"});
             
                               while (db.rs.next()) {
        
            def.addRow(new Object[]{db.rs.getString(1),db.rs.getString(2),db.rs.getString(3),db.rs.getString(4),db.rs.getString(5),db.rs.getString(6),db.rs.getString(7)});
                               }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new View_Dentist().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(View_Dentist.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
