...
public class Delete_Dentist extends javax.swing.JFrame {

    //  updateRecep =new JButton("");
    public Delete_Dentist() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Delete Dentist");
    ...
    private void deleteRecepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteRecepActionPerformed
       ...
       if( db.deleteDentist(id)==true)
           
          JOptionPane.showMessageDialog(null, "dentist deleted successfuly");
      else 
          JOptionPane.showMessageDialog(null, "dentist deleting failed");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Delete_Dentist().setVisible(true);
            }
        });
    }
